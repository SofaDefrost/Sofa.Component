...
class DistanceMapping(Object):
    """Compute edge extensions"""

    def __init__(self, template: Optional[str] = None, name: Optional[str] = None,printLog: Optional[bool] = None,tags: Optional[object] = None,bbox: Optional[object] = None,componentState: Optional[object] = None,listening: Optional[bool] = None,mapForces: Optional[bool] = None,mapConstraints: Optional[bool] = None,mapMasses: Optional[bool] = None,mapMatrices: Optional[bool] = None,applyRestPosition: Optional[bool] = None,geometricStiffness: Optional[object] = None,computeDistance: Optional[bool] = None,restLengths: Optional[SofaArray] = None,showObjectScale: Optional[float] = None,showColor: Optional[object] = None):
        """Compute edge extensions
        ...
        Args:
           ...
           computeDistance (bool):   if 'computeDistance = true', then rest length of each element equal 0, otherwise rest length is the initial lenght of each of them
...
-Stabilized: the exact geometric stiffness is approximated in order to improve stability
    ...
    class Parameters:
        """Parameter for the construction of the DistanceMapping component"""
        ...
        computeDistance: Optional[bool | LinkPath] = None 
        'if computeDistance = true, then rest length of each element equal 0, otherwise rest length is the initial lenght of each of them'
    ...
    def new_parameters() -> Parameters: 
        return DistanceMapping.Parameters()
