...
class TriangularBendingSprings(Object):
    """Springs added to a triangular mesh to prevent bending"""

    def __init__(self, template: Optional[str] = None, name: Optional[str] = None,printLog: Optional[bool] = None,tags: Optional[object] = None,bbox: Optional[object] = None,componentState: Optional[object] = None,listening: Optional[bool] = None,isCompliance: Optional[bool] = None,rayleighStiffness: Optional[float] = None,stiffness: Optional[float] = None,damping: Optional[float] = None,showSprings: Optional[bool] = None,edgeInfo: Optional[SofaArray] = None):
        """Springs added to a triangular mesh to prevent bending
        ...
        Args:
           ...
           showSprings (bool):   option to draw springs
    ...
    class Parameters:
        """Parameter for the construction of the TriangularBendingSprings component"""
        ...
        showSprings: Optional[bool | LinkPath] = None 
        'option to draw springs'
    ...
    def new_parameters() -> Parameters: 
        return TriangularBendingSprings.Parameters()
