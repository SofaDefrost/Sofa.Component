...
class QuadBendingSprings(Object):
    ...
    def __init__(self, template: Optional[str] = None, name: Optional[str] = None,printLog: Optional[bool] = None,tags: Optional[object] = None,bbox: Optional[object] = None,componentState: Optional[object] = None,listening: Optional[bool] = None,isCompliance: Optional[bool] = None,rayleighStiffness: Optional[float] = None,stiffness: Optional[float] = None,damping: Optional[float] = None,showArrowSize: Optional[float] = None,drawMode: Optional[int] = None,spring: Optional[SofaArray] = None,springsIndices1: Optional[SofaArray] = None,springsIndices2: Optional[SofaArray] = None,indices1: Optional[SofaArray] = None,indices2: Optional[SofaArray] = None,lengths: Optional[SofaArray] = None,localRange: Optional[SofaArray] = None):
        """Springs added to a quad mesh to prevent bending
...
- 2: Arrow
    ...
    class Parameters:
        """Parameter for the construction of the QuadBendingSprings component"""
    ...
    def new_parameters() -> Parameters: 
        return QuadBendingSprings.Parameters()
