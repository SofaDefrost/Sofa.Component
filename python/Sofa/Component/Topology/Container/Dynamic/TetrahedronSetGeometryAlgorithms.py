...
class TetrahedronSetGeometryAlgorithms(Object):
    """Tetrahedron set geometry algorithms"""

    def __init__(self, template: Optional[str] = None, name: Optional[str] = None,printLog: Optional[bool] = None,tags: Optional[object] = None,bbox: Optional[object] = None,componentState: Optional[object] = None,listening: Optional[bool] = None,showIndicesScale: Optional[float] = None,showPointIndices: Optional[bool] = None,tagMechanics: Optional[str] = None,showEdgeIndices: Optional[bool] = None,drawEdges: Optional[bool] = None,drawColorEdges: Optional[object] = None,showTriangleIndices: Optional[bool] = None,drawTriangles: Optional[bool] = None,drawColorTriangles: Optional[object] = None,drawNormals: Optional[bool] = None,drawNormalLength: Optional[float] = None,recomputeTrianglesOrientation: Optional[bool] = None,flipNormals: Optional[bool] = None,showTetrahedraIndices: Optional[bool] = None,drawTetrahedra: Optional[bool] = None,drawScaleTetrahedra: Optional[float] = None,drawColorTetrahedra: Optional[object] = None):
        """Tetrahedron set geometry algorithms
        ...
        Args:
           ...
           drawColorTetrahedra (object):   RGBA code color used to draw tetrahedra.
           ...
           drawScaleTetrahedra (float):   Scale of the terahedra (between 0 and 1; if <1.0, it produces gaps between the tetrahedra)
           drawTetrahedra (bool):   if true, draw the tetrahedra in the topology
           ...
           showTetrahedraIndices (bool):   Debug : view Tetrahedrons indices
    ...
    class Parameters:
        """Parameter for the construction of the TetrahedronSetGeometryAlgorithms component"""
        ...
        showTetrahedraIndices: Optional[bool | LinkPath] = None 
        'Debug : view Tetrahedrons indices'

        drawTetrahedra: Optional[bool | LinkPath] = None 
        'if true, draw the tetrahedra in the topology'

        drawScaleTetrahedra: Optional[float | LinkPath] = None 
        'Scale of the terahedra (between 0 and 1; if <1.0, it produces gaps between the tetrahedra)'

        drawColorTetrahedra: Optional[object | LinkPath] = None 
        'RGBA code color used to draw tetrahedra.'
    ...
    def new_parameters() -> Parameters: 
        return TetrahedronSetGeometryAlgorithms.Parameters()
