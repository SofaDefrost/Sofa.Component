...
class QuadSetTopologyContainer(Object):
    ...
    class Parameters:
        """Parameter for the construction of the QuadSetTopologyContainer component"""
    ...
    def new_parameters() -> Parameters: 
        return QuadSetTopologyContainer.Parameters()
