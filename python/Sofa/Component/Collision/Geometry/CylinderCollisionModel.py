...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
           ...
           defaultHeight (float):   The default height
           defaultLocalAxis (SofaArray):   The default local axis cylinder is modeled around
           defaultRadius (float):   The default radius
           ...
           heights (SofaArray):   The cylinder heights
           ...
           radii (SofaArray):   Radius of each cylinder
    ...
    radii: Data[SofaArray] 
    'Radius of each cylinder'

    heights: Data[SofaArray] 
    'The cylinder heights'

    defaultRadius: Data[float] 
    'The default radius'

    defaultHeight: Data[float] 
    'The default height'

    defaultLocalAxis: Data[SofaArray] 
    ...
    class Parameters:
        """Parameter for the construction of the CylinderCollisionModel component"""
        ...
        radii: Optional[SofaArray | LinkPath] = None 
        'Radius of each cylinder'

        heights: Optional[SofaArray | LinkPath] = None 
        'The cylinder heights'

        defaultRadius: Optional[float | LinkPath] = None 
        'The default radius'

        defaultHeight: Optional[float | LinkPath] = None 
        'The default height'

        defaultLocalAxis: Optional[SofaArray | LinkPath] = None 
        'The default local axis cylinder is modeled around'
    ...
    def new_parameters() -> Parameters: 
        return CylinderCollisionModel.Parameters()
