...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
           ...
           listRadius (SofaArray):   Radius of each sphere
           ...
           radius (float):   Default Radius. (default=1.0)
    ...
    listRadius: Data[SofaArray] 
    'Radius of each sphere'

    radius: Data[float] 
    'Default Radius. (default=1.0)'
    ...
    class Parameters:
        """Parameter for the construction of the SphereCollisionModel component"""
        ...
        listRadius: Optional[SofaArray | LinkPath] = None 
        'Radius of each sphere'

        radius: Optional[float | LinkPath] = None 
        'Default Radius. (default=1.0)'

        showImpostors: Optional[bool | LinkPath] = None 
        'Draw spheres as impostors instead of "real" spheres'
    ...
    def new_parameters() -> Parameters: 
        return SphereCollisionModel.Parameters()
